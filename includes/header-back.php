  ...
  <aside class="app-sidebar" id="sidebar">
    ...
    <div class="sidebar-menu">
      <ul class="sidebar-nav">
        ...
        <li <?php if($currentFile=="manage_withdraw_request.php"){?>class="active"<?php }?>> <a href="manage_transaction.php">
          <div class="icon"> <i class="fa fa-list" aria-hidden="true"></i> </div>
          <div class="title">Transaction</div>
          </a> 
        </li>
        <li <?php if($currentFile=="manage_support.php"){?>class="active"<?php }?>> <a href="manage_contact_list.php">
