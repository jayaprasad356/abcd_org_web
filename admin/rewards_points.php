  ...
  $settings_row=mysqli_fetch_assoc($result);
	...
	if(isset($_POST['submit']))
	{
		$data = array(
                ...
                'min_redeem_amount'  =>  $_POST['minimum_widthrawal'],
                        ...
                        <div class="col-md-12">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <label class="col-md-2 control-label"><?php echo $settings_row['redeem_currency'];?></label>                          </div>                      </div>                      <div class="col-md-6">                        <label class="col-md-6 control-label">Minimum Widthrawals =</label>                          <div class="col-md-6">                            <input type="integer" name="minimum_widthrawal" id="minimum_widthrawal" value="<?php echo $settings_row['minimum_widthrawal'];?>" class="form-control">                                                    </div>                      </div>                       </div>                     </div>				  </div>				<div class="section">                <div class="section-body">
                  <div class="form-group">
